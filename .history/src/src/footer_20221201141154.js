...
function Footer() {
  return (
      ...
      <div className='container-footer'>
        <div className='center-grid-footer'>
          <div className='grid-footer'>
            ...
            <div className='card-footer'>
              <p style={{ fontWeight: '600',marginBottom:'30px'}}>Discover</p>
              <p>Travel & Safety</p>
              <p>Travel Credit</p>
              <p>Gift Cards</p>
              <p>Jabaram Citizen</p>
            ...
            <div className='card-footer'>
              <p style={{ fontWeight: '600',marginBottom:'30px'}}>Hosting</p>
              <p >Why Host</p>
            ...
            <div className='card-footer'>
              <link<div className='link-to-privacy'>
    ...
    <div className='container-end-footer'>
      <div className='center-end-footer'>
        <p>© Jabaram, Inc. All rights reserved.</p>
      </div>
    </div>
    </div>
  )
